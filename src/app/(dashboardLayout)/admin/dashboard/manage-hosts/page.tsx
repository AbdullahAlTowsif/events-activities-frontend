import HostsManagement from '@/components/modules/Admin/GetAll/HostsManagement';
import { Metadata } from 'next';
import { Suspense } from 'react';

export const metadata: Metadata = {
    title: 'Manage Hosts - Admin Dashboard',
    description: 'Manage all hosts on the platform',
};
